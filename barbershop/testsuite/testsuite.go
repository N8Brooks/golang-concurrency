// Package testsuite contains reusable behavioral tests for barbershop implementations.
package testsuite
...
func startCustomer(shop Barbershop, ctx context.Context) customerRun {
	run := customerRun{
...
func startBarber(shop Barbershop, ctx context.Context) barberRun {
	run := barberRun{
...
func runOneShot(t *testing.T, shop Barbershop, ctx context.Context, barberFirst bool) {
	t.Helper()
...
func Run(t *testing.T, newImpl func(capacity int) Barbershop) {
	t.Helper()
...
func Benchmark(b *testing.B, newImpl func(capacity int) Barbershop) {
	b.Helper()
	b.ReportAllocs()
