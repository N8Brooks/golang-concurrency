...
// Package searchinsertdelete contains the challenge version of the
// search-insert-delete problem.
//
// Searchers may examine the list concurrently with each other. Inserters must
// be mutually exclusive with other inserters, but may run concurrently with
// searchers. Deleters require exclusive access against every other category.
package searchinsertdelete
...
type SearchInsertDelete struct {
...
func NewSearchInsertDelete() *SearchInsertDelete {
	return &SearchInsertDelete{
...
func (s *SearchInsertDelete) Searcher(ctx context.Context, search func()) error {
...
func (s *SearchInsertDelete) Inserter(ctx context.Context, insert func()) error {
...
func (s *SearchInsertDelete) Deleter(ctx context.Context, remove func()) error {
